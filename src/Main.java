...
public class Main {
    public static void main(String[] args){
        ...
        try
        {
            ...
            resul = sentencia.executeQuery("SELECT fruteria.nombre,articulo.nombre,articulo.categoria,stock.cantidad FROM stock join " +
                    "fruteria on (stock.cod_f=fruteria.cod) join articulo on (articulo.cod=stock.cod_art)");

            while(resul.next())
            {
                System.out.println(resul.getString(1) + " " + resul.getString(2) + " " + resul.getString(3)+ " " + resul.getString(4));
            }
